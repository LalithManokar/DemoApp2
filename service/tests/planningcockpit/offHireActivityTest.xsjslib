...
var lib, offHireActivityLib, activity, activityLib, xslib, logger, constants;

describe('offHireActivityLib test', function () {
    beforeOnce(function() {
        lib = $.import('/sap/tm/trp/service/xslib/railxs.xsjslib');
        lib.SimpleRest.prototype.handle = function() {
        };
        // lib to test
        offHireActivityLib = $.import('/sap/tm/trp/service/planningcockpit/offHireActivity.xsjslib');
        activity = offHireActivityLib.OffHireActivityService;
        // lib containing functions used by all activities
        activityLib = offHireActivityLib.lib;
    ...
    describe('create an offHireActivityLib', function () {
        beforeEach(function () {
            spyOn(activityLib, 'Procedure').and.callFake(function () {
                return function (activityType, scenarioId, fromLocId, ToLocId, startTime, endTime, equipType, quantity, cost, contractNo, routeId, desc) {
                     switch (scenarioId) {
                        case 1:
                            return {
                                ACTIVITY_ID: 1,
        ...
        it('should create an offHireActivityLib', function () {
            var params = {
                obj: {
