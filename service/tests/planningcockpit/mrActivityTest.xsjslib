...
var lib, MRActivityLib, activity, activityLib, xslib, logger, constants;

describe('MRactivity test', function () {
    beforeOnce(function() {
        lib = $.import('/sap/tm/trp/service/xslib/railxs.xsjslib');
        lib.SimpleRest.prototype.handle = function() {
        };
        // lib to test
        MRActivityLib = $.import('/sap/tm/trp/service/planningcockpit/mrActivity.xsjslib');
        activity = MRActivityLib.MRActivityService;
        // lib containing functions used by all activities
        activityLib = MRActivityLib.lib;
    ...
    describe('create an MRActivity', function () {
        beforeEach(function () {
        ...
        it('should create an MRActivity', function () {
            var params = {
                obj: {
