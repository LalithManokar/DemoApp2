...
var lib, repositioningActivityLib, activity, activityLib, xslib, logger, constants;

describe(
        'repositioning activity test',
        function() {
            beforeOnce(function() {
                ...
                // lib to test
                repositioningActivityLib = $
                        .import('/sap/tm/trp/service/planningcockpit/repositioningActivity.xsjslib');
                activity = repositioningActivityLib.activity;
                // lib containing functions used by all activities
                activityLib = repositioningActivityLib.lib;
            ...
            describe(
                    'create an repositioningActivity',
                    function() {
                        beforeEach(function() {
                        ...
                        it('should create an repositioningActivity', function() {
                            var params = {
                                obj : {
            ...
            it('query route for activity', function() {
                spyOn(activityLib, 'Procedure').and.callFake(function() {
                    return function() {
                        return {
                            MESSAGE : 'MSG_SUCCESS_STATUS',
                            ROUTE_CONN_LIST : [ {
                                ROUTE_ID : 1,
                                FROM_TIME : '2016-07-19T16:00:00.000Z'
                            } ]
                        };
                    };
                });
                ...
                expect(activity.route(params)).toEqual({
                    CONNECTIONS : [ {
                        ROUTE_ID : 1,
                        FROM_TIME : '2016-07-19T16:00:00.000Z'
                    } ]
