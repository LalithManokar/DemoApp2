...
var upload = function(csv, resourceCategory, connection_id) {
    ...
    var validationProcedureName = constants.SP_PKG_RULEGROUP_DATA_UPLOAD + '::' + "p_ext_pr_finalize_ruleset_group_validate";
...
var save = function(resourceCategory, connectionId) {    
    ...
    procName = constants.SP_PKG_RULEGROUP_DATA_UPLOAD + '::' + "p_ext_pr_finalize_ruleset_group_save";
