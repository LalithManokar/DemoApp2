...
var procName = "sap.tm.trp.db.pickupreturn.algorithm::p_return";
...
function returnTableContainsRouteIdBookingId(returnTable, correctResult) {
    ...
    for (var rowNumber in returnTable) {
        ...
        if (row.hasOwnProperty("BOOKING_ID") && row.hasOwnProperty("TO_LOCATION")) {
            tableResults[rowNumber][0] = row.BOOKING_ID;
            tableResults[rowNumber][1] = row.TO_LOCATION;
        }
    }
...
describe('this test suite tests procedure "p_return"', function() {
    ...
    it('case 2', function() {
        ...
        //data packages
        var dataPackage = "sap.tm.trp.db.tests.pickupreturn.algorithm.data_haulage.return_case02";
