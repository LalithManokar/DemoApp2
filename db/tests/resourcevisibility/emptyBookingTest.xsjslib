...
describe("Empty Bookings Unit Test", function() {
    ...
    it("should get list of empty bookings", function() {
        ...
        var response = jasmine.callHTTPService("/sap/tm/trp/service/odata.xsodata/EmptyBookingMasterTableParameters(LOCATION_FILTER_ID=1001,EQUIPMENT_FILTER_ID=152,FILTER_ON=0,FROM_DATE=datetime'',TO_DATE=datetime'',BOOKING_TYPE='',LOCATION='',EQUIPMENT_TYPE='',DATA_PROVIDER_TYPE='')/Results?$skip=119&$top=100&$orderby=ORDER_ID%20asc", $.net.http.GET, null, headers);
